...
var (
	...
	// DefaultPublicationYear holds the default value on creation for the "publication_year" field.
	DefaultPublicationYear func() time.Time
	// UpdateDefaultPublicationYear holds the default value on update for the "publication_year" field.
	UpdateDefaultPublicationYear func() time.Time
